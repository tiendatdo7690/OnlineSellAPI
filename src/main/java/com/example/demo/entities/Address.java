...
public class Address implements Serializable {
    ...
    private static final long serialVersionUID = 7971042497761032717L;
    ...
    @JoinColumn(name = "customer_id" , foreignKey= @ForeignKey(name = "Fk_customer_address"), nullable = true)
